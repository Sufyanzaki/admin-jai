...
export default function SidebarData() {
  ...
  const { errors, onSubmit, handleSubmit, control, setValue, watch, register } = useSearchForm();
          ...
          <SidebarGroup className="p-0">
            ...
            <SidebarGroupContent className="space-y-4">
              ...
              <div className="hidden group-data-[collapsible=icon]:flex flex-col gap-2 items-center">
                <SidebarMenuButton className="text-white cursor-pointer p-0 rounded-[5px] bg-white" size="md">
            ...
            <CollapsibleTrigger asChild>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">{t("Advanced Search")}</span>
                </div>
