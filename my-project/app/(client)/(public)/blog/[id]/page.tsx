                ...
                <div className="py-[50px] pt-[114px] xl:pt-[124px] xl:pb-[92px]">
                    ...
                    <div className="grid lg:grid-cols-3 gap-12">
                        <div className="lg:col-span-2">
                            ...
                            {/* Article Content */}
                            <div
                                className="text-sm prose prose-lg max-w-none"
                                dangerouslySetInnerHTML={{
                                    __html: unescapeHtml(
                                        blog?.description ? blog?.description : t("Blog content")
                                    ),
                                }}
                            ></div>
                        </div>
                    ...
                    <div className="mt-16 bg-gray-200 h-32 flex items-center justify-center rounded-lg">
                        <span className="text-gray-500 text-lg">{t("Banner space")}</span>
                    </div>
                </div>
            </Container>
        </div>
