...
export function PhotoUploadForm() {
  ...
  return (
    <div className="space-y-8 py-3 text-start">
      <h4 className="text-2xl font-bold text-gray-900">{registrationSettings?.myImageTitle}</h4>
      <h5 className="text-xl font-medium text-gray-800 mt-[-20px]">{registrationSettings?.myImageDescription}</h5>
