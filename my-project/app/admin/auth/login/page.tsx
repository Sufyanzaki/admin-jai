    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-950 px-4 py-12">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <img src="https://ticketprijs.nl/admin/logoImages/1730182765_logo%20(1).png" alt="Logo" className="mx-auto w-fit" />
        </div>

        <Card className="border-gray-800 bg-gray-900">
          <CardHeader>
            <CardTitle className="text-xl text-white">{t("Sign in to your account")}</CardTitle>
            <CardDescription className="text-gray-400">{t("Enter your credentials to access the dashboard")}</CardDescription>
          </CardHeader>
