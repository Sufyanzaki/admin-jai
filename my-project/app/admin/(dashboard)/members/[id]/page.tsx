...
import BasicInformation from "@/app/admin/(dashboard)/members/[id]/_components/BasicInformation";
import Living from "@/app/admin/(dashboard)/members/[id]/_components/Living";
import AboutMe from "@/app/admin/(dashboard)/members/[id]/_components/AboutMe";
import EducationAndCareer from "@/app/admin/(dashboard)/members/[id]/_components/EducationAndCareer";
import Languages from "@/app/admin/(dashboard)/members/[id]/_components/Languages";
import HobbiesAndInterest from "@/app/admin/(dashboard)/members/[id]/_components/HobbiesAndInterest";
import PersonalityAndBehavior from "@/app/admin/(dashboard)/members/[id]/_components/PersonalityAndBehavior";
import LifeStyle from "@/app/admin/(dashboard)/members/[id]/_components/LifeStyle";
