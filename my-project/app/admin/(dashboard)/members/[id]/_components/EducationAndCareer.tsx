    ...
    return (
      <CardContent>
        <div className="flex items-center justify-center py-8">
          ...
          <span className="ml-2 text-sm text-muted-foreground">{t('Loading education & career information...')}</span>
        </div>
      </CardContent>
    );
  }
    ...
    return (
      <CardContent>
        <div className="text-center py-8">
          <p className="text-sm text-muted-foreground">{t('No education & career information available')}</p>
        </div>
      </CardContent>
    );
  }
